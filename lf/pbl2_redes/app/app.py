...
def ab_balances():
    ...
    ab1 = response.json()
    response = requests.post(f'http://{host_a2}:{port_a2}/balance', json={'user_id': user_id})
    ab2 = response.json()
    data = {'bankName': ,'abName1': ab1['bank'], 'abName2': ab2['bank'], 'abBalance1': ab1['balance'], 'abBalance2': ab2['balance']}
